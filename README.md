...
今天把第三章相关的系统调用修改了一下，并且添加了第四章程序运行所必须的几个系统调用，mmap和munmap。成功跑通了，运行结果如下：

![image-20220906105107160](pic/image-20220906105107160.png)

### 9.7

今天复习了一下rcore tutorial文档的一到四章，做了个第二阶段总结的PPT。